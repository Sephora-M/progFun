...
our $alien_key = 'mac_2_8_12_uni_gcc_3_4';

{
    my $VAR1;
    $Wx::dlls = $VAR1 = {
          'base' => 'libwx_base_carbonu-2.8.dylib',
          'richtext' => 'libwx_macu_richtext-2.8.dylib',
          'core' => 'libwx_macu_core-2.8.dylib',
          'stc' => 'libwx_macu_stc-2.8.dylib',
          'fl' => 'libwx_macu_fl-2.8.dylib',
          'aui' => 'libwx_macu_aui-2.8.dylib',
          'gl' => 'libwx_macu_gl-2.8.dylib',
          'net' => 'libwx_base_carbonu_net-2.8.dylib',
          'html' => 'libwx_macu_html-2.8.dylib',
          'gizmos' => 'libwx_macu_gizmos-2.8.dylib',
          'qa' => 'libwx_macu_qa-2.8.dylib',
          'media' => 'libwx_macu_media-2.8.dylib',
          'xml' => 'libwx_base_carbonu_xml-2.8.dylib',
          'animate' => 'libwx_macu_animate-2.8.dylib',
          'xrc' => 'libwx_macu_xrc-2.8.dylib',
          'adv' => 'libwx_macu_adv-2.8.dylib'
        };
;
}
...
sub _alien_path {
  ...
  return unless length 'mac_2_8_12_uni';
  foreach ( @INC ) {
    if( -d "$_/Alien/wxWidgets/mac_2_8_12_uni" ) {
      $wx_path = "$_/Alien/wxWidgets/mac_2_8_12_uni/lib";
      last;
    }
  }
}
